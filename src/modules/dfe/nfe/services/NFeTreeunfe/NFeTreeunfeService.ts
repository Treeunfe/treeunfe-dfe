...
class NFETreeunfeService implements NFETreeunfeServiceImpl {
  ...
  async DFE_LoadEnvironment({ config }: { config: TreeunfeNFe }) {
    try {
      ...
      this.gerarConsulta = new GerarConsulta(
        this.environment,
        this.utility,
        this.xmlBuilder
      );
  ...
  async NFE_ConsultaStatusServico() {
    try {
      const nfeStatusServicoService = new NFEStatusServicoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
  ...
  async NFE_ConsultaProtocolo(chave: string) {
    try {
      const nfeConsultaProtocoloService = new NFEconsultaProtocoloService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const nfeConsultaProtocolo = new NFEConsultaProtocolo(
  ...
  async NFE_RecepcaoEvento(evento: EventoNFe) {
    try {
      const nfeRecepcaoEventoService = new NFERecepcaoEventoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
  ...
  async NFE_EventoPrevioDeEmissaoEmContingencia(evento: EPEC) {
    try {
      const nfeEpecService = new NFEEpecService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      logger.error(``, error, {
        context: "NFE_EventoPrevioDeEmissaoEmContingencia",
      });
  ...
  async NFE_Cancelamento(evento: Cancelamento) {
    try {
      const nfeCancelamentoService = new NFECancelamentoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
  ...
  async NFE_CienciaDaOperacao(evento: CienciaDaOperacao) {
    try {
      const nfeCienciaDaOperacaoService = new NFECienciaDaOperacaoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const nfeCienciaDaOperacao = new NFECienciaDaOperacao(
  ...
  async NFE_ConfirmacaoDaOperacao(evento: ConfirmacaoDaOperacao) {
    try {
      const nfeConfirmacaoDaOperacaoService = new NFECienciaDaOperacaoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const nfeConfirmacaoDaOperacao = new NFEConfirmacaoDaOperacao(
  ...
  async NFE_OperacaoNaoRealizada(evento: OperacaoNaoRealizada) {
    try {
      const nfeOperacaoNaoRealizadaService = new NFEOperacaoNaoRealizadaService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const nfeOperacaoNaoRealizada = new NFEOperacaoNaoRealizada(
  ...
  async NFE_CartaDeCorrecao(evento: CartaDeCorrecao) {
    try {
      const nfeCartaDeCorrecaoService = new NFECartaDeCorrecaoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const nfeCartaDeCorrecao = new NFECartaDeCorrecao(
  ...
  async NFE_DesconhecimentoDaOperacao(evento: DesconhecimentoDaOperacao) {
    try {
      const nfeDesconhecimentoDaOperacaoService =
        new NFEDesconhecimentoDaOperacaoService(
          this.environment,
          this.utility,
          this.xmlBuilder,
          this.axios,
      ...
      const nfeDesconhecimentoDaOperacao = new NFEDesconhecimentoDaOperacao(
  ...
  async NFE_DistribuicaoDFe(data: ConsultaNFe) {
    try {
      const distribuicaoDFeService = new NFEDistribuicaoDFeService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
  ...
  async NFE_DistribuicaoDFePorUltNSU(data: DFePorUltimoNSU) {
    try {
      const distribuicaoDFeService = new NFEDistribuicaoDFePorUltNSUService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const distribuicaoDFe = new NFEDistribuicaoDFePorUltNSU(
  ...
  async NFE_DistribuicaoDFePorNSU(data: DFePorNSU) {
    try {
      const distribuicaoDFeService = new NFEDistribuicaoDFePorNSUService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const distribuicaoDFe = new NFEDistribuicaoDFePorNSU(
        distribuicaoDFeService
      );
      const response = await distribuicaoDFe.Exec(data);
  ...
  async NFE_DistribuicaoDFePorChave(data: DFePorChaveNFe) {
    try {
      const distribuicaoDFeService = new NFEDistribuicaoDFePorChaveService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
      ...
      const distribuicaoDFe = new NFEDistribuicaoDFePorChave(
        distribuicaoDFeService
      );
      const response = await distribuicaoDFe.Exec(data);
  ...
  async NFE_Autorizacao(data: NFe) {
    try {
      const autorizacaoService = new NFEAutorizacaoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
  ...
  async NFCE_Autorizacao(data: NFe) {
    try {
      const autorizacaoService = new NFCEAutorizacaoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
  ...
  async NFE_Inutilizacao(data: InutilizacaoData) {
    try {
      const inutilizacaoService = new NFEInutilizacaoService(
        this.environment,
        this.utility,
        this.xmlBuilder,
        this.axios,
