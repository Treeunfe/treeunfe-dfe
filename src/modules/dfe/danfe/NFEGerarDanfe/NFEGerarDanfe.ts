...
class NFEGerarDanfe {
  ...
  _buildGuia() {
    ...
    this.doc
      .fontSize(5)
      .text(
        `RECEBEMOS DE ${this.emit.xNome} OS PRODUTOS / SERVIÇOS CONSTANTES DA NOTA FISCAL INDICADO AO LADO`,
        10,
        26,
        {
    ...
    this.doc
      ...
      .text(
        `EMISSÃO: ${format(
          new Date(this.ide.dhEmi),
          "dd-MM-yyyy"
        )} -  DEST. / REM.: ${
          this.dest?.xNome || ""
        }  -  VALOR TOTAL: R$ ${parseFloat(
          String(this.total.ICMSTot.vNF)
        ).toFixed(2)}`,
        10,
        33.5,
        {
    ...
    this.doc
      .fontSize(8.8)
      .font("Times-Bold")
      .text(`Nº ${String(this.ide.nNF).padStart(2, "0")}`, 480, 40.5, {
        characterSpacing: 1.5,
        align: "center",
      });
    this.doc
      .fontSize(8.5)
      .font("Times-Roman")
      .text(`SÉRIE ${this.ide.serie.padStart(3, "0")}`, 480, 53, {
        characterSpacing: 1.5,
        align: "center",
      });
    /** BOTTON LEFT */
    ...
    this.doc
      .fontSize(5)
      .text(`IDENTIFICAÇÃO E ASSINATURA DO RECEBEDOR`, 75 + 10, 46.5, {
        characterSpacing: 0.5,
      });
  }
  ...
  _buildSeparator() {
    ...
    // Desenhe a linha
    this.doc
      .moveTo(left, 69) // Início da linha
  ...
  _buildHeader(pos: number) {
    ...
    const documento = this.documento.mascaraCnpjCpf(
      CNPJCPF || CNPJ || CPF || ""
    );
    this.setLineStyle(0.75, "#1c1c1c");
    ...
    const _buildIdentificacaoEmit = () => {
      ...
      this.doc
        .fontSize(5)
        .text(`IDENTIFICAÇÃO DO EMITENTE`, 10, topIdentificacao_1 + 3.5, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .font("Times-Bold")
        .text(this.emit.xNome, 35, topIdentificacao_1 + 14, {
          characterSpacing: 1,
          width: 170,
          lineBreak: true,
          lineGap: 4,
      ...
      this.doc
        ...
        .font("Times-Roman")
        .text(
          `${this.emit.enderEmit.xLgr}, ${this.emit.enderEmit.nro} ${
            this.emit.xFant ? `- ${this.emit.xFant}` : ""
          }`,
          10,
          topIdentificacao_1 + 44,
          {
            characterSpacing: 1,
            width: 181,
            lineBreak: true,
    ...
    const _buildIdentificacaoDanfe = () => {
      ...
      this.doc
        .fontSize(12)
        .font("Times-Bold")
        .text(`DANFE`, 203, topIdentificacao_1 + 8, {
          characterSpacing: 1.5,
          width: 112.7,
          align: "center",
        });
      ...
      this.doc
        .fontSize(8)
        .font("Times-Roman")
        .text(`0 - ENTRADA`, 217, topIdentificacao_1 + 40, {
          characterSpacing: 0.5,
          align: "left",
        });
      ...
      this.doc
        .fontSize(14)
        .font("Times-Bold")
        .text(String(this.ide.tpNF), left + 280, topIdentificacao_1 + 42.5);
      this.doc
        .fontSize(8.8)
        .text(
          `Nº ${String(this.ide.nNF).padStart(2, "0")}`,
          208,
          topIdentificacao_1 + 65,
          {
            characterSpacing: 1,
          }
        );
      ...
      this.doc
        .fontSize(8.8)
        .text(
          `SÉRIE ${this.ide.serie.padStart(3, "0")}`,
          208,
          topIdentificacao_1 + 78,
          {
            characterSpacing: 1.5,
            width: 112.7,
            align: "center",
    ...
    const _buildIdentificacaoNFe = () => {
      ...
      if (this.barcodeBuffer) {
        // Verifica se o buffer do barcode existe
        this.doc.image(
          this.barcodeBuffer,
          left + 323.5,
          topIdentificacao_1 + 3,
          { width: 230, height: 30 }
        );
      } else {
        this.doc
          ...
          .fillColor("red")
          .text(
            "Erro ao carregar barcode",
            left + 316,
            topIdentificacao_1 + 12,
            {
              width: 256.73,
              align: "center",
            }
      ...
      this.doc
        .fontSize(5)
        .font("Times-Roman")
        .text(`CHAVE DE ACESSO`, left + 314, topIdentificacao_1 + 38, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(6)
        .text(this.chave, left + 310.2, topIdentificacao_1 + 47, {
          characterSpacing: 1,
          width: 256.73,
          align: "center",
        });
      ...
      this.doc
        .fontSize(5)
        .text("NATUREZA DE OPERAÇÃO", left + 4, topIdentificacao_1 + 102, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(this.ide.natOp, left + 4, topIdentificacao_1 + 112, {
          characterSpacing: 1,
        });
      ...
      if (Number(this.ide.tpAmb) === 2 || this.enviada) {
        ...
        if (this.protNFe?.infProt.dhRecbto) {
          dhRecbto = format(
            new Date(this.protNFe?.infProt.dhRecbto),
            "dd/MM/yyyy HH:mm:ss"
          );
        }
        const xProtNfe = `${String(
          this.protNFe?.infProt.nProt || ""
        )} ${dhRecbto}`;
        this.doc
          .fontSize(5)
          .text(
        ...
        this.doc
          .fontSize(8)
          .text(xProtNfe, left + 314.2, topIdentificacao_1 + 112, {
            characterSpacing: 1,
          });
      }
    };
    ...
    const _buildIdentificacaoPessoa = () => {
      ...
      this.doc
        .fontSize(5)
        .text("INSCRIÇÃO ESTADUAL", left + 4, topIdentificacao_1 + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(this.emit.IE, left + 5, topIdentificacao_1 + 135, {
          characterSpacing: 1,
        });

      this.doc
        .rect(left + 189.5, topIdentificacao_1 + 121, 187.93, 23)
        .stroke();
      this.doc
        .fontSize(5)
        .text(
      ...
      this.doc
        .fontSize(8)
        .text(
          String(this.emit.IEST || ""),
          left + 194.5,
          topIdentificacao_1 + 135,
          {
            characterSpacing: 1,
          }
        );
      ...
      this.doc
        .rect(left + 377.43, topIdentificacao_1 + 121, 189.5, 23)
        .stroke();
      this.doc
        .fontSize(5)
        .text("CNPJ / CPF", left + 381.43, topIdentificacao_1 + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(documento, left + 386.43, topIdentificacao_1 + 135, {
          characterSpacing: 1,
        });
    };
  ...
  _buildDestinatario() {
    const { top, left } = this.doc.page.margins;
    const docDest = this.documento.mascaraCnpjCpf(
      this.dest?.CNPJCPF || this.dest?.CNPJ || this.dest?.CPF || ""
    );
    this.setLineStyle(0.75, "#1c1c1c");
    ...
    const _buildDestPessoa = () => {
      ...
      this.doc
        .fontSize(5)
        .font("Times-Roman")
        .text("NOME / RAZÃO SOCIAL", left + 4, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      ...
      this.doc
        .fontSize(5)
        .text("CNPJ / CPF", left + 402, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      ...
      this.doc
        .fontSize(5)
        .text("DATA DA EMISSÃO", left + 496, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          format(new Date(this.ide.dhEmi), "dd-MM-yyyy"),
          left + 497,
          topDestinatario + 135,
          {
            characterSpacing: 1,
    ...
    const _buildDestLogradouro = () => {
      ...
      this.doc
        .fontSize(8)
        .text(
          `${this.dest?.enderDest?.xLgr || ""}, ${
            this.dest?.enderDest?.nro || ""
          }`,
          left + 5,
          topDestinatario + 158,
          {
      ...
      this.doc
        .fontSize(5)
        .text("BAIRRO / DISTRITO", left + 324, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      ...
      if (textLineHeight < cellHeightForText) {
        yPosForBairro =
          cellContentYBase -
          (cellHeightForText - textLineHeight) / 2 +
          textLineHeight * 0.3; // ajuste
      }
      ...
      this.doc
        .fontSize(8)
        .text(
          String(this.dest?.enderDest?.CEP || ""),
          left + 443.5,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("DATA SAÍDA / ENTRADA", left + 496, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
    ...
    const _buildDestEndereco = () => {
      ...
      this.doc
        .fontSize(8)
        .text(
          String(this.dest?.enderDest?.xMun || ""),
          left + 5,
          topDestinatario + 181,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("FONE / FAX", left + 250.5, topDestinatario + 171, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          this.dest?.enderDest?.fone || "",
          left + 250.5,
          topDestinatario + 181,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("INSCRIÇÃO ESTADUAL", left + 403.5, topDestinatario + 171, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          String(this.dest?.indIEDest || ""),
          left + 403.5,
          topDestinatario + 181,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("HORA DA SAÍDA", left + 496, topDestinatario + 171, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(format(new Date(), "HH:mm"), left + 497, topDestinatario + 181, {
          characterSpacing: 1,
        });
    };
    ...
    this.doc
      .fontSize(6)
      .font("Times-Bold")
      .text("DESTINATÁRIO / REMETENTE", left, topDestinatario + 114, {
        characterSpacing: 0.5,
      });
    _buildDestPessoa();
  ...
  _builCalculoImposto() {
    ...
    const _buildCalcImposto = () => {
      ...
      this.doc
        .fontSize(5)
        .font("Times-Roman")
        .text("BASE DE CÁLCULO DO ICMS", left + 4, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vBC)).toFixed(2),
          left - 8,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("VALOR DO ICMS", left + 90, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vICMS)).toFixed(2),
          left + 86 - 16,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("BASE CÁLC. ICMS SUBST", left + 169, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vBCST)).toFixed(2),
          left + 165 - 16,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("VALOR DO ICMS SUBST.", left + 248, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vST)).toFixed(2),
          left + 244 - 16,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("VALOR APROX. DOS TRIBUTOS", left + 327, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(this.total.ICMSTot.vTotTrib || "0").toFixed(2),
          left + 323 - 6,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .rect(left + 414, topDestinatario + 120, 152.93, 23)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      this.doc
        .fontSize(5)
        .text("VALOR TOTAL DOS PRODUTOS", left + 418, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vProd)).toFixed(2),
          left + 480 - 8,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("VALOR DO FRETE", left + 4, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vFrete)).toFixed(2),
          left - 8,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("VALOR DO SEGURO", left + 90, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vSeg)).toFixed(2),
          left + 86 - 16,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vDesc)).toFixed(2),
          left + 165 - 16,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("OUTRAS DESP. ACESS.", left + 248, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vOutro)).toFixed(2),
          left + 244 - 16,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("VALOR DO IPI", left + 327, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vIPI)).toFixed(2),
          left + 323 - 6,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .rect(left + 414, topDestinatario + 143, 152.93, 23)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      this.doc
        .fontSize(5)
        .text("VALOR TOTAL DA NOTA", left + 418, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          parseFloat(String(this.total.ICMSTot.vNF)).toFixed(2),
          left + 480 - 8,
          topDestinatario + 158,
          {
            characterSpacing: 1,
    ...
    this.doc
      .fontSize(6)
      .font("Times-Bold")
      .text("CÁLCULO DO IMPOSTO", left, topDestinatario + 114, {
        characterSpacing: 0.5,
      });
    _buildCalcImposto();
  }
  ...
  _builTransporte() {
    ...
    const _buildVolumeTransporte = () => {
      if (this.transp.vol) {
        ...
        const createVolume = (vol: Vol) => {
          ...
          this.doc
            .fontSize(8)
            .text(String(vol?.qVol || ""), left - 8, topTrnasportValue, {
              characterSpacing: 1,
              align: "right",
              width: 68.5,
            });
          ...
          this.doc
            .fontSize(8)
            .text(String(vol?.esp || ""), left + 73.5, topTrnasportValue, {
              characterSpacing: 1,
            });
          ...
          this.doc
            .fontSize(8)
            .text(String(vol?.marca || ""), left + 174, topTrnasportValue, {
              characterSpacing: 1,
            });
          this.doc.rect(left + 269.5, topTrnasport, 100.5, 23).stroke();
          this.doc
            .fontSize(5)
            .text("NUMERAÇÃO", left + 273.5, topTrnasportTitle, {
              characterSpacing: 0.5,
            });
          this.doc
            .fontSize(8)
            .text(String(vol?.nVol || ""), left + 274.5, topTrnasportValue, {
              characterSpacing: 1,
            });
          this.doc.rect(left + 370, topTrnasport, 102.6, 23).stroke();
          this.doc
            .fontSize(5)
            .text("PESO BRUTO", left + 374, topTrnasportTitle, {
              characterSpacing: 0.5,
            });
          this.doc
            .fontSize(8)
            .text(String(vol?.nVol || ""), left + 375, topTrnasportValue, {
              characterSpacing: 1,
            });
          //96,43
          ...
          this.doc
            .fontSize(5)
            .text("PESO LÍQUIDO", left + 474.5, topTrnasportTitle, {
              characterSpacing: 0.5,
            });
          this.doc
            .fontSize(8)
            .text(String(vol?.nVol || ""), left + 475.5, topTrnasportValue, {
              characterSpacing: 1,
            });
    ...
    const _buildCalcImposto = () => {
      const documento = this.documento.mascaraCnpjCpf(
        this.transp.transporta?.CNPJCPF ||
          this.transp.transporta?.CNPJ ||
          this.transp.transporta?.CPF ||
          ""
      );
      /** LINHA 1 */
      ...
      this.doc
        .fontSize(5)
        .font("Times-Roman")
        .text("RAZÃO SOCIAL", left + 4, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          this.transp.transporta?.xNome || "",
          left + 5,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("FRETE POR CONTA", left + 252.5, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(getModFrete(), left + 253.5, topDestinatario + 135, {
          characterSpacing: 1,
        });
      this.doc.rect(left + 338.5, topDestinatario + 120, 50, 23).stroke();
      this.doc
        .fontSize(5)
        .text("CÓDIGO ANTT", left + 342.5, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          this.transp?.veicTransp?.RNTC || "",
          left + 343.5,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("PLACA DO VEÍCULO", left + 391.5, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          this.transp?.veicTransp?.placa || "",
          left + 393.5,
          topDestinatario + 135,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("CNPJ / CPF", left + 476.5, topDestinatario + 125, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(documento, left + 477.5, topDestinatario + 135, {
          characterSpacing: 1,
        });
      ...
      this.doc
        .fontSize(5)
        .text("MUNICÍPIO", left + 342.5, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          this.transp.transporta?.xMun || "",
          left + 343.5,
          topDestinatario + 158,
          {
            characterSpacing: 1,
      ...
      this.doc
        .fontSize(5)
        .text("INSCRIÇÃO ESTADUAL", left + 476.5, topDestinatario + 148, {
          characterSpacing: 0.5,
        });
      this.doc
        .fontSize(8)
        .text(
          this.transp?.transporta?.IE || "",
          left + 476.5,
          topDestinatario + 158,
          {
            characterSpacing: 1,
  ...
  _buildProdutos() {
    ...
    this.doc
      ...
      .font("Times-Bold")
      .fillColor("black")
      .text("DADOS DO PRODUTO / SERVIÇOS", left, 452, {
        characterSpacing: 0.5,
      });
    ...
    const header = (top: number) => {
      this.doc
        .rect(left, top, 40, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      this.doc
        .font("Times-Roman")
        .fontSize(5.7)
        .text("CÓDIGO DO PROD. / SERV", left, top + 2.8, {
          width: 40,
          align: "center",
        });
      this.doc
        .rect(left + 40, top, 138, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 178, top, 30, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 208, top, 17, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 225, top, 28, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 253, top, 23, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 276, top, 25, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 301, top, 37.23, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 338.23, top, 39.23, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 377.46, top, 33.23, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 410.69, top, 38, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 448.69, top, 35, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 483.69, top, 38, defaultItemHeight)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 521.69, top + 7.5, 22.5, 7.5)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
      ...
      this.doc
        .rect(left + 544.19, top + 7.5, 22.75, 7.5)
        .fillAndStroke("#DDDDDD", "#1c1c1c");
      this.setLineStyle(0.75, "#1c1c1c");
    ...
    const row = (top: number, item: DetProd) => {
      ...
      function getValoresIPI(IPI: IPI | undefined): {
        vIPI: string;
        pIPI: string;
      } {
        if (!IPI) {
      ...
      this.doc
        .font("Times-Roman")
        .fontSize(6)
        .text(item.prod.cProd || "", left + 2, top + 3, {
          width: 40,
        });
      ...
      this.doc.text(
        item.prod.uCom || item.prod.uTrib || "",
        left + 256,
        top + 5.9,
        {
          width: 23,
      ...
      const quant = parseFloat(
        String(item.prod.qCom || item.prod.qTrib)
      ...
      const valUnit = parseFloat(
        String(item.prod.vUnCom || item.prod.vUnTrib || "0")
      ).toLocaleString("pt-BR", {
        minimumFractionDigits: 2,
      ...
      const valDesc = parseFloat(String(item.prod.vDesc || "0")).toLocaleString(
        "pt-BR",
      ...
      const valLiq = parseFloat(String(item.prod.vProd || "0")).toLocaleString(
        "pt-BR",
        { minimumFractionDigits: 2, maximumFractionDigits: 2 }
      );
      ...
      if (y + defaultItemHeight > this.doc.page.height - 160) {
        ...
        if (currentPage > 0) {
          ...
          this.doc
            ...
            .font("Times-Bold")
            .fillColor("black")
            .text("DADOS DO PRODUTO / SERVIÇOS", left, 175, {
              characterSpacing: 0.5,
            });
          header(185);
        }
  ...
  _buildFooter() {
    ...
    this.doc
      .fontSize(6)
      .font("Times-Bold")
      .text("DADOS ADICIONAIS", left, topDestinatario - 5, {
        characterSpacing: 0.5,
      });
    ...
    this.doc
      .fontSize(5)
      .font("Times-Roman")
      .text("INFORMAÇÕES COMPLEMENTARES", 10, topDestinatario + 4.5, {
        characterSpacing: 0.5,
      });
    this.doc
      .fontSize(8)
      .text(this.infAdic?.infCpl || "", 13, topDestinatario + 13, {
        characterSpacing: 1,
        width: 400,
      });
    ...
    this.doc
      .fontSize(5)
      .text("RESERVADO AO FISCO", 408 + 10, topDestinatario + 4.5, {
        characterSpacing: 0.5,
      });
    this.doc
      .fontSize(8)
      .text(String(this.infAdic?.infAdFisco || ""), 13, topDestinatario + 13, {
        characterSpacing: 1,
        width: 400,
      });
    ...
    if (this.exibirMarcaDaguaDanfe) {
      const topPosition =
        Number(Number(this.ide.tpAmb)) !== 2
          ? topDestinatario + 38
          : topDestinatario + 58;
      const leftPosition =
        Number(Number(this.ide.tpAmb)) !== 2 ? left + 150 : left + 100;
      this.doc
        .fontSize(26)
        .font("Times-Bold")
        .fillColor("#c7c7c7")
        .text("Treeunfe NFe", leftPosition, topPosition, {
          characterSpacing: 0.5,
        });
    }
