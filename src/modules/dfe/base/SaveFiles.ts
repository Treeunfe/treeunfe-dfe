...
class SaveFiles implements SaveFilesImpl {
  ...
  public salvaArquivos(
    ...
    const createFileName = (prefix: string | undefined) => {
      ...
      const nfePart =
        responseInJson && responseInJson.chNFe
          ? `-${responseInJson.chNFe}`
          : "";
